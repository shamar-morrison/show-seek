/**
 * Trakt Logo Component
 *
 * Renders the Trakt logo from the actual SVG file.
 * Uses SvgXml to load the raw SVG content from assets.
 *
 * Note: The SVG has been modified to use inline fill attributes instead of
 * CSS classes, which react-native-svg doesn't properly interpret.
 */

import React from 'react';
import { SvgXml } from 'react-native-svg';

// The exact SVG from assets/images/trakt-logo.svg with CSS classes converted to inline fills
const traktLogoSvg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 48 48">
  <defs>
  ...
  <g id="logomark.square.gradient">
    <path id="background" fill="url(#radial-gradient)" d="M48,11.26v25.47c0,6.22-5.05,11.27-11.27,11.27H11.26c-6.22,0-11.26-5.05-11.26-11.27V11.26C0,5.04,5.04,0,11.26,0h25.47c3.32,0,6.3,1.43,8.37,3.72.47.52.89,1.08,1.25,1.68.18.29.34.59.5.89.33.68.6,1.39.79,2.14.1.37.18.76.23,1.15.09.54.13,1.11.13,1.68Z"/>
    <g id="checkbox">
...
export function TraktLogo({ size = 24 }: TraktLogoProps) {
  return <SvgXml xml={traktLogoSvg} width={size} height={size} />;
}
