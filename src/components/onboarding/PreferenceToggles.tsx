...
interface PreferenceTogglesProps {
  ...
  dataSaver: boolean;
  onBlurPlotSpoilersChange: (value: boolean) => void;
    ...
    >
      ...
      <View style={styles.toggleCard}>
        <View style={styles.toggleInfo}>
          <Text style={styles.toggleTitle}>{t('profile.blurPlotSpoilers')}</Text>
          <Text style={styles.toggleDescription}>{t('profile.blurPlotSpoilersDescription')}</Text>
        </View>
        <Switch
          value={blurPlotSpoilers}
          onValueChange={onBlurPlotSpoilersChange}
